...
This document deals with the different broods of the multivoltine species, and then matches the right temperature record for each species, to create the data sets to be passed to the modelling. 

```{R message = FALSE}
library(tidyverse)
library(readxl)

OUMNH_data_temps<- read_csv('../data/OUMNH/OUMNH_data_temps_Monthly.csv')
NHM_data_temps <- read_csv('../data/NHM/NHM_w_temps_Monthly.csv')
...
```{r}
OUMNH_for_models
write_csv(OUMNH_for_models, "../data/OUMNH/OUMNH_for_models_monthly.csv")
```
