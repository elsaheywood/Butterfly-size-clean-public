...
This script fits and saves brms models predicting size for each species. The core model is: log(Size)  ~ YearRescale + Temp  + Latitude + Sex
...
```{r}
NHM_ForFitting <- read_csv(  '../data/NHM/NHM_for_models_monthly.csv')
OUM_ForFitting <- read_csv(  '../data/OUMNH/OUMNH_for_models_monthly.csv')
```
