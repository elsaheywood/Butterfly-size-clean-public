...
NHM_for_fitting <- read_csv('../data/NHM/NHM_for_models_monthly.csv')
```
...
FamilyCorrelates_a <- ggplot(x, aes( x = Family, fill = RedListListed))+
  ...
  scale_fill_manual(values = c('darkred', 'lightgreen'), name = 'Red List:')+
...
plot_grid(Predictor_CorrPlot,
          ...
          FamilyCorrelates_b,
          FamilyCorrelates_c, 
          labels = c('a) Correlations between Cross-Species Predictors',
